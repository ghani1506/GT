...
<style>
:root {{
  --gong-size: clamp(44px, 9.2vw, 108px);
...
.instrument {{
  ...
  padding: clamp(16px, 3vw, 38px) clamp(8px, 2vw, 26px);
  border-radius: 34px;
...
.row {{
  display: grid;
  grid-auto-rows: var(--gong-size);
  gap: var(--gap);
  justify-content: center;
  align-items: center;
}}
.row.top {{ grid-template-columns: repeat(5, var(--gong-size)); transform: translateX(calc(var(--gong-size) * .58)); }}
.row.bottom {{ grid-template-columns: repeat(8, var(--gong-size)); }}
...
@media (max-width: 430px) {{
  :root {{ --gong-size: clamp(36px, 10.15vw, 48px); --gap: 7px; }}
  .app {{ min-height: 690px; padding: 12px 8px; }}
  .row.top {{ transform: translateX(calc(var(--gong-size) * .52)); }}
...
<div id="app" class="app">
  ...
  <div id="settingsPanel" class="settings-panel">
    ...
    <div class="small">For authentic sound, upload real Gulintangan/Caklempong samples. Files are loaded in your browser only.</div>
  </div>
  ...
  <main class="instrument" aria-label="Gulintangan Brunei instrument">
    <section class="row top" aria-label="Sharp notes">
      <button class="gong" data-note="sharp1" data-freq="349.23" aria-label="gong sharp 1"></button>
      <button class="gong" data-note="sharp2" data-freq="392.00" aria-label="gong sharp 2"></button>
      <button class="gong" data-note="sharp3" data-freq="466.16" aria-label="gong sharp 3"></button>
      <button class="gong" data-note="sharp4" data-freq="523.25" aria-label="gong sharp 4"></button>
      <button class="gong" data-note="sharp5" data-freq="587.33" aria-label="gong sharp 5"></button>
    </section>
    <section class="row bottom" aria-label="Main notes">
      <button class="gong" data-note="1" data-freq="261.63" aria-label="gong 1"></button>
      <button class="gong" data-note="2" data-freq="293.66" aria-label="gong 2"></button>
      <button class="gong" data-note="3" data-freq="329.63" aria-label="gong 3"></button>
      <button class="gong" data-note="4" data-freq="392.00" aria-label="gong 4"></button>
      <button class="gong" data-note="5" data-freq="440.00" aria-label="gong 5"></button>
      <button class="gong" data-note="6" data-freq="493.88" aria-label="gong 6"></button>
      <button class="gong" data-note="7" data-freq="587.33" aria-label="gong 7"></button>
      <button class="gong" data-note="8" data-freq="659.25" aria-label="gong 8"></button>
    </section>
  </main>
</div>
...
function playSynth(freq) {{
  ...
  out.gain.exponentialRampToValueAtTime(1.0, now + 0.006);
  ...
  noise.buffer = makeNoiseBuffer(0.28);
  ...
  ng.gain.exponentialRampToValueAtTime(0.0005, now + 0.22);
