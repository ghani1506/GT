...
.keyboard {{
  ...
  max-width: 100%;
  height: calc((var(--gong-size) * 1.78) + var(--gap));
  margin: 0 auto;
}}
...
/* Exact piano-style positions: C# between C/D, D# between D/E, F# between F/G, G# between G/A, A# between A/B */
.gong.cs {{ left: calc((var(--gong-size) + var(--gap)) * 1 - (var(--gap) / 2)); }}
.gong.ds {{ left: calc((var(--gong-size) + var(--gap)) * 2 - (var(--gap) / 2)); }}
.gong.fs {{ left: calc((var(--gong-size) + var(--gap)) * 4 - (var(--gap) / 2)); }}
.gong.gs {{ left: calc((var(--gong-size) + var(--gap)) * 5 - (var(--gap) / 2)); }}
.gong.as {{ left: calc((var(--gong-size) + var(--gap)) * 6 - (var(--gap) / 2)); }}
...
@media (max-width: 430px) {{
  ...
  .keyboard {{ height: calc((var(--gong-size) * 1.82) + var(--gap)); }}
}}
</style>
</head>
<body>
<div id="app" class="app">
  ...
  <main class="instrument" aria-label="Gulintangan Brunei instrument">
    <section class="keyboard" aria-label="Keyboard style gong layout">
      <button class="gong sharp cs" data-note="C#" data-freq="277.18" aria-label="C sharp gong, between C and D"></button>
      <button class="gong sharp ds" data-note="D#" data-freq="311.13" aria-label="D sharp gong, between D and E"></button>
      <button class="gong sharp fs" data-note="F#" data-freq="369.99" aria-label="F sharp gong, between F and G"></button>
      <button class="gong sharp gs" data-note="G#" data-freq="415.30" aria-label="G sharp gong, between G and A"></button>
      <button class="gong sharp as" data-note="A#" data-freq="466.16" aria-label="A sharp gong, between A and B"></button>
      ...
      <section class="row bottom" aria-label="Natural notes">
        ...
        <button class="gong" data-note="C2" data-freq="523.25" aria-label="higher C gong"></button>
      </section>
    </section>
  </main>
</div>
...
const keyMap = ['w','e','t','y','u','a','s','d','f','g','h','j','k'];
